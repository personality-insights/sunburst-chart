...
const d3PersonalityProfileV2 = require('../profiles/v2/index');
const d3PersonalityProfileV3 = require('../profiles/v3/index');
...
module.exports=(function () {
  ...
  var PersonalitySunburstChart = function (containerId, options) {
    ...
    function showVizualization(theProfile, personImageUrl) {
      ...
      var d3Profile = version === 'v3' ? new d3PersonalityProfileV3(theProfile) : new d3PersonalityProfileV2(theProfile);
