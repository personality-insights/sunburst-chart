...
var d3PersonalityProfileV2 = require('../profiles/v2/index');
var d3PersonalityProfileV3 = require('../profiles/v3/index');
...
module.exports=(function () {
  ...
  var PersonalitySunburstChart = function (containerId, options) {
    ...
    function showVizualization(theProfile, personImageUrl) {
      ...
      console.debug('showVizualization: theProfile');
      console.debug(theProfile);

      var widgetId = self.containerId;

      var d3Profile = self.version === 'v3' ? new d3PersonalityProfileV3(theProfile) : new d3PersonalityProfileV2(theProfile);
      console.debug('showVizualization: d3Profile');
      console.debug(d3Profile.d3Json());
    ...
    /*
    function getD3Profile(theProfile){
      var d3Profile = new d3PersonalityProfileV2(theProfile);
      return d3Profile.d3Json();
    }

    self.d3Profile = getD3Profile;
    */
